...
public class CRC16M {
    ...
    public static byte[] HexString2Buf2(String src) {
    	int len = src.length();
    ...
    public static byte[] getSendBuf2(String toSend) {
    	byte[] bb = HexString2Buf2(toSend);
    	CRC16M crc16 = new CRC16M();
    	crc16.update(bb, bb.length - 2);
    	int ri = crc16.getValue();
    	bb[bb.length - 1] = (byte) (0xff & ri);
...
//	        sb.append(' ');    
	 ...
	 * @return
	 */
	public static String getHexFromAsc(String[] sbuf) {
	    StringBuilder sb = new StringBuilder("02");    
        for (String str : sbuf) {
        	sb.append(CRC16M.str2HexStr(str)).append("");
		}
        sb.append("03");
	    return sb.toString();
	}
	 ...
	 * @return
	 */
	public static String getEnd(String[] strs) {
    	StringBuilder sb = new StringBuilder("02"); 
    	for (int i = 0; i < strs.length - 2; i++) {
    		sb.append(str2HexStr(strs[i])).append("");
		}
//    	System.out.println("makeChecksum"+makeChecksum(sb.toString()));
    	return makeChecksum(sb.toString()).substring(2);
	}
