...
public class TagView extends View {
    ...
    private MissionActionB mAbstractAction, mOriginAction;
    ...
    public TagView(Context context, MissionActionB missionAction, int language){
        super(context);
        this.language = language;
        init(context, missionAction);
    }

    public TagView(Context context, MissionActionB missionAction, int defaultImageID, int language){
        super(context);
        this.language = language;
        init(context, missionAction);
    ...
    private void init(Context context, MissionActionB missionAction){
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mRipplePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mRipplePaint.setStyle(Paint.Style.FILL);
        mRectF = new RectF();
        mPath = new Path();
        mOriginText = missionAction.getStringToShow(language);
        mOriginAction = missionAction;
...
//                bug: https://github.com/whilu/AndroidTagView/issues/88
    ...
    public MissionActionB getMissionAction() {
