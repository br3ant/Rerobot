...
public class PieView extends View {
    ...
    private void init() {
        radius = DisplayUtil.dp2px( 80);
        centerPointRadius =DisplayUtil.dp2px( 2);
        yOffset = DisplayUtil.dp2px( 5);
        showRateSize = DisplayUtil.dp2px( 10);
...
//            Log.e("TAG", "startAngle=" + startAngle + "--sweepAngle=" + ((int) (mRateList.get(i) * (360)) - offset));
        ...
        //(3)绘制内部中空的圆
        mPaint.setColor(ContextCompat.getColor(mContext, R.color.color_323446));
        mPaint.setStyle(Paint.Style.FILL);
