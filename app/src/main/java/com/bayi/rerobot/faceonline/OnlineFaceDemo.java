package com.bayi.rerobot.faceonline;
...
import com.bayi.rerobot.IdentifyGroup.GroupManagerActivity;
import com.bayi.rerobot.R;
import com.bayi.rerobot.util.FaceUtil;
...
public class OnlineFaceDemo extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img=(ImageView) findViewById(R.id.online_img);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.online_camera:
                ...
                Uri uri=getUriForFile(OnlineFaceDemo.this,
                        "com.bayi.rerobot.fileprovider", mPictureFile);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_PICTURE_CHOOSE) {
            ...
            // 跳转到图片裁剪页面
            Uri uri=getUriForFile(OnlineFaceDemo.this,
                    "com.bayi.rerobot.fileprovider", new File(fileSrc));
            Glide.with(this)
                    .load(uri)
                    .diskCacheStrategy(DiskCacheStrategy.NONE)
                    .override(320, 320)//指定图片大小
                    .into(img);
            mImageData=FaceUtil.Bitmap2Bytes( ((BitmapDrawable)img.getDrawable()).getBitmap());
            //FaceUtil.cropPicture(this,uri,this);
